...
### 4. `datuakBektorizatu`
Aurrez zehaztutako bektorizazio onena aplikatzen die datu-multzoei, testua entrenamendurako erabilgarriak diren balio booleano edo zenbakizkoetara aldatuz eta diskoan gordez.
...
### 5. `parametroEkorketa`
BayesNet sailkatzailearen topologia edo bilaketa-algoritmo onenak topatzeko *Fine-Tuning* prozesua (hiperparametroen bilaketa zehatza) exekutatzen du.
...
Amaierako eredu definitiboa edo `.model` fitxategia eraikitzen du. Horretarako, Train eta Dev fitxategiak batzen ditu modu transpartentean datu bolumena handitzeko.
